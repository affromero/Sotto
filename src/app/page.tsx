...
export default function LandingPage() {
  ...
  return (
    <div ref={pageRef} className={styles.page}>
      ...
      <section className={styles.hero} id="hero" aria-label="Introduction">
        ...
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSub}>
            Podcasts you can remix, question, and share with the world. Create with AI or import
            your own.
          </p>
          <TopicSuggestions />
          ...
          <p className={styles.heroCtaNote}>
            3 free podcasts every month. No credit card required.
          </p>
        </div>
        ...
        <div className={styles.inner}>
          <div className={styles.pillars}>
            <article className={`${styles.pillar} ${styles.rev}`}>
              ...
              <h3>Fork any podcast</h3>
              <p>
                Found a podcast you love? Fork it. Change the angle, go deeper, add your own voice.
                Attribution always links back to the original.
              </p>
            </article>
            <article className={`${styles.pillar} ${styles.rev} ${styles.d1}`}>
              ...
              <p>
                Build your network of curious minds. Follow creators, discover what they&apos;re
                learning, and never miss a new podcast.
              </p>
            </article>
            <article className={`${styles.pillar} ${styles.rev} ${styles.d2}`}>
              ...
              <h3>Discover what the world is learning</h3>
              <p>
                A public feed of knowledge. Search by topic, browse trending, sort by most forked.
                Every podcast is a conversation starter.
              </p>
            </article>
          </div>
        </div>
      ...
      {/* ====== TRUST SIGNALS ====== */}
      <section className={`${styles.section} ${styles.sectionAlt}`} aria-label="Verified knowledge">
        <div className={styles.inner}>
          <div className={`${styles.split}`}>
            <div className={`${styles.splitText} ${styles.rev}`}>
              <span className={styles.overline}>Verified Knowledge</span>
              <h2 className={styles.h2}>Every claim, every source, checked.</h2>
              <p className={styles.bodyLg}>
                Sotto&apos;s verification pipeline extracts claims from every podcast, traces them
                to sources, and runs a 4-layer check: URL validation, CrossRef DOI lookup, OpenAlex
                search, and AI evaluation. Unverified claims get flagged or removed.
              </p>
              <div className={styles.trustFeatures}>
                <div className={styles.trustFeature}>
                  {CHECK}
                  <span>Sources verified across 4 layers</span>
                </div>
                <div className={styles.trustFeature}>
                  {CHECK}
                  <span>Citations linked to original papers</span>
                </div>
                <div className={styles.trustFeature}>
                  {CHECK}
                  <span>Flagged claims are transparently marked</span>
                </div>
              </div>
            </div>
            <div className={`${styles.splitVisual} ${styles.rev} ${styles.d1}`}>
              <div className={styles.chatMock}>
                ...
                <div className={styles.chatBody}>
                  <div className={`${styles.chatMsg} ${styles.chatBot}`}>
                    ...
                    <div className={styles.chatBubble}>URL validation</div>
                  </div>
                  <div className={`${styles.chatMsg} ${styles.chatBot}`}>
                    <div className={styles.chatAvatar} aria-hidden="true">
                      2
                    </div>
                    <div className={styles.chatBubble}>CrossRef DOI lookup</div>
                  </div>
                  <div className={`${styles.chatMsg} ${styles.chatBot}`}>
                    <div className={styles.chatAvatar} aria-hidden="true">
                      3
                    </div>
                    <div className={styles.chatBubble}>OpenAlex search</div>
                  </div>
                  <div className={`${styles.chatMsg} ${styles.chatBot}`}>
                    <div className={styles.chatAvatar} aria-hidden="true">
                      4
                    </div>
                    <div className={styles.chatBubble}>AI evaluation</div>
                  </div>
      ...
      {/* ====== DISCOVERY CHAT DEMO ====== */}
      <section className={styles.section} aria-label="Product demo">
        <div className={styles.inner}>
          <div className={styles.split}>
            <div className={`${styles.splitText} ${styles.rev}`}>
      ...
      {/* ====== IMPORT SECTION ====== */}
      <section className={styles.section} aria-label="Universal import">
        <div className={styles.inner}>
          <div className={styles.split}>
            <div className={`${styles.splitText} ${styles.rev}`}>
              <span className={styles.overline}>Universal Import</span>
              <h2 className={styles.h2}>Bring any podcast. Make it social.</h2>
              <p className={styles.bodyLg}>
                Import audio from NotebookLM, GenFM, or your own recordings. Sotto transcribes it,
                adds it to the network, and unlocks the full social layer — fork, like, save, share.
              </p>
              <div className={styles.importFeatures}>
                <div className={styles.importFeature}>
                  {CHECK}
                  <span>Drag-and-drop MP3/WAV upload</span>
                </div>
                <div className={styles.importFeature}>
                  {CHECK}
                  <span>Automatic transcription via AI</span>
                </div>
                <div className={styles.importFeature}>
                  {CHECK}
                  <span>Full social features on imported audio</span>
                </div>
              </div>
            </div>
            <div className={`${styles.splitVisual} ${styles.rev} ${styles.d1}`}>
              <div className={styles.chatMock}>
                ...
                <div className={styles.chatBody}>
                  <div className={`${styles.chatMsg} ${styles.chatBot}`}>
                    ...
                    <div className={styles.chatBubble}>
                      Drop your MP3 or WAV file here, or click to browse.
                    </div>
                  </div>
                  <div className={styles.chatGenerating}>
                    <div className={styles.chatSpinner} aria-hidden="true" />
                    Transcribing and adding to network...
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* ====== VOICES ====== */}
      <section className={styles.section} id="voices" aria-label="Voice selection">
        <div className={styles.inner}>
      ...
      >
        <div className={styles.inner}>
          ...
          <p className={styles.tierFootnote}>
            All plans include unlimited listening.{' '}
            <a href="/pricing">See all plans including BYOK Power tier</a>.
          </p>
        </div>
      </section>
      ...
      <section className={styles.cta} aria-label="Get started">
        ...
        <div className={`${styles.ctaContent} ${styles.rev}`}>
          <h2 className={styles.ctaTitle}>The best podcasts haven&apos;t been made yet.</h2>
          <p className={styles.ctaSub}>
            Create with AI, import your own, or fork something brilliant. Join the open podcast
            network.
          </p>
