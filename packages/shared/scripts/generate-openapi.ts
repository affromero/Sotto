...
import {
  ...
  listLearningTargetsResponseSchema,
  memoryEdgeSchema,
...
const namedSchemas: Record<string, z.ZodType> = {
  ...
  FocusTargetKind: focusTargetKindSchema,
  FocusTargetSource: focusTargetSourceSchema,
  ...
  LearningTarget: learningTargetSchema,
  ListLearningTargetsResponse: listLearningTargetsResponseSchema,
  AddLearningTargetRequest: addLearningTargetRequestSchema,
  ...
  PlacementQuestion: placementQuestionSchema,
  GeneratePlacementResponse: generatePlacementResponseSchema,
  SubmitPlacementRequest: submitPlacementRequestSchema,
  SubmitPlacementResponse: submitPlacementResponseSchema,
  DeduceFromNotesRequest: deduceFromNotesRequestSchema,
  DeduceFromNotesResponse: deduceFromNotesResponseSchema,
  ConfirmFromNotesRequest: confirmFromNotesRequestSchema,
  ConfirmFromNotesResponse: confirmFromNotesResponseSchema,
  ManualPlacementRequest: manualPlacementRequestSchema,
  ManualPlacementResponse: manualPlacementResponseSchema,
  DeleteCourseRequest: deleteCourseRequestSchema,
  DeleteCourseResponse: deleteCourseResponseSchema,
  MemoryNode: memoryNodeSchema,
  MemoryEdge: memoryEdgeSchema,
