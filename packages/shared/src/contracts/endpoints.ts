...
export const endpoints: EndpointDef[] = [
  ...
  {
    id: 'listLearningTargets',
    method: 'GET',
    path: '/api/v1/courses/{courseId}/learning-targets',
    summary: 'Learner-marked words, phrases, and sentences for focused practice.',
    auth: 'bearer',
    response: listLearningTargetsResponseSchema,
    successStatuses: [200],
  },
  {
    id: 'addLearningTarget',
    method: 'POST',
    path: '/api/v1/courses/{courseId}/learning-targets',
    summary: 'Add or refresh a learner-marked difficult word, phrase, or sentence.',
    auth: 'bearer',
    request: addLearningTargetRequestSchema,
    response: learningTargetSchema,
    successStatuses: [201],
  },
  {
    id: 'addLearningTargetVisualCue',
    method: 'POST',
    path: '/api/v1/courses/{courseId}/learning-targets/{targetId}/visual-cue',
    summary: 'Attach a visual cue to a learner-marked target when configured.',
    auth: 'bearer',
    response: learningTargetSchema,
    successStatuses: [200],
  },
  {
    id: 'generateLearningTargetPronunciation',
    method: 'POST',
    path: '/api/v1/courses/{courseId}/learning-targets/{targetId}/pronunciation',
    summary: 'Generate pronunciation audio for a learner-marked target when configured.',
    auth: 'bearer',
    response: learningTargetSchema,
    successStatuses: [200],
  },
  ...
  },
  {
    id: 'getCourseExams',
    method: 'GET',
    path: '/api/v1/courses/{courseId}/exams',
    summary: "The exam this course can sit plus the learner's past attempts.",
    auth: 'bearer',
    response: courseExamsResponseSchema,
    successStatuses: [200],
  },
  {
    id: 'getActivity',
    method: 'GET',
    path: '/api/v1/learn/activity',
    summary: 'Daily study activity and streaks for the learner.',
    auth: 'bearer',
