...
describe('public links', () => {
  ...
  it('returns configured https links', () => {
    vi.stubEnv('NEXT_PUBLIC_GITHUB_URL', 'https://github.com/example/private-podcasts');
    ...
    expect(getPublicGithubUrl()).toBe('https://github.com/example/private-podcasts');
  ...
  it('rejects non-https or invalid links', () => {
    vi.stubEnv('NEXT_PUBLIC_GITHUB_URL', 'http://github.com/example/private-podcasts');
