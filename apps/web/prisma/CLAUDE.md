...
| Auto Model Config | AutoModelConfig                                                                                                                                                 | Singleton row: per-plan "Auto" model resolution (Free + Pro AI/TTS/STT provider+model defaults, `freeIncludedModels`/`proIncludedModels` Json? for picker filtering) |
