...
| Podcast Ratings   | PodcastRating                                                                                                                                                   | Creator quality ratings (voice, accuracy, flow, overall) per podcast — unique per user+podcast                                       |
...
| Voice Clones      | VoiceClone (includes `requestable`, `priceInCents`)                                                                                                             | User voice clones (name, ElevenLabs ID, source, requestable flag, per-podcast pricing)                                              |
...
| Content Safety    | ModerationAction, Report, ContentFlag                                                                                                                           | Moderation actions, user reports (with ReportReason/ReportStatus enums), auto-flagged content                                         |
| Mobile Push       | ExpoPushToken                                                                                                                                                   | Expo push notification tokens (platform: ios/android)                                                                                 |
| Waitlist          | Waitlist                                                                                                                                                        | Early access waitlist signups (email, source)                                                                                         |
