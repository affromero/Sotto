...
export const VOICE_POOL: VoicePoolEntry[] = [
  ...
  {
    name: 'Eric',
    ids: { elevenlabs: 'cjVigY5qzO86Huf0OWal', openai: 'cedar' },
    gender: 'male',
    accent: 'american',
    ageRange: 'young',
  ...
  {
    name: 'Brian',
    ids: { elevenlabs: 'nPczCjzI2devNBz1zQrb', openai: 'onyx' },
    gender: 'male',
    accent: 'american',
    ageRange: 'mature',
  ...
  {
    name: 'Will',
    ids: { elevenlabs: 'bIHbv24MWmeRgasZH58o', openai: 'fable' },
    gender: 'male',
    accent: 'american',
    ageRange: 'young',
  ...
  {
    name: 'Roger',
    ids: { elevenlabs: 'CwhRBWXzGAHq8TQ4Fs17', openai: 'cedar' },
    gender: 'male',
    accent: 'american',
    ageRange: 'middle',
  ...
  {
    name: 'Aria',
    ids: { elevenlabs: '9BWtsMINqrJLrRacOk9x', openai: 'nova' },
    gender: 'female',
    accent: 'american',
    ageRange: 'young',
  ...
  {
    name: 'Jessica',
    ids: { elevenlabs: 'cgSgspJ2msm6clMCkdW9', openai: 'marin' },
    gender: 'female',
    accent: 'american',
    ageRange: 'young',
  ...
  {
    name: 'Laura',
    ids: { elevenlabs: 'FGY2WhTYpPnrIDTdsKH5', openai: 'nova' },
    gender: 'female',
    accent: 'american',
    ageRange: 'young',
  ...
  {
    name: 'Matilda',
    ids: { elevenlabs: 'XrExE9yKIg1WjnnlVkGX', openai: 'shimmer' },
    gender: 'female',
    accent: 'american',
    ageRange: 'mature',
  ...
  {
    name: 'Alice',
    ids: { elevenlabs: 'Xb7hH8MSUJpSbSDYk0k2', openai: 'marin' },
    gender: 'female',
    accent: 'british',
    ageRange: 'young',
...
/**
 * Look up a human-readable voice name by ID across ALL voice pools
 * (main pool + Cartesia, Hume, Fal, Inworld, MiniMax, Mistral).
 */
export function findVoiceName(voiceId: string): string | undefined {
  const main = findByVoiceId(voiceId);
  if (main) return main.name;

  // Lazy import to avoid circular deps — these pools are static arrays
  // eslint-disable-next-line @typescript-eslint/no-require-imports
  const { CARTESIA_VOICE_POOL, HUME_VOICE_POOL, FAL_VOICE_POOL, INWORLD_VOICE_POOL, MINIMAX_VOICE_POOL, MISTRAL_VOICE_POOL } = require('./providers/tts-voices') as typeof import('./providers/tts-voices');
  const providerPools = [CARTESIA_VOICE_POOL, HUME_VOICE_POOL, FAL_VOICE_POOL, INWORLD_VOICE_POOL, MINIMAX_VOICE_POOL, MISTRAL_VOICE_POOL];
