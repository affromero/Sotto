...
const FORMATS: Record<ExamInstitution, InstitutionFormat> = {
  ...
  GOETHE: {
    ...
    sections: [
      { skill: 'READING', part: 'Lesen', format: 'mc', itemCount: 6, baseMinutes: 45, weight: 0.25 },
      { skill: 'LISTENING', part: 'Hören', format: 'listening', itemCount: 5, baseMinutes: 30, weight: 0.25 },
      { skill: 'WRITING', part: 'Schreiben', format: 'writing', itemCount: 2, baseMinutes: 45, weight: 0.25 },
      { skill: 'SPEAKING', part: 'Sprechen', format: 'speaking', itemCount: 3, baseMinutes: 15, weight: 0.25 },
    ],
  },
  ...
  DELE: {
    ...
    sections: [
      { skill: 'READING', part: 'Comprensión de lectura', format: 'mc', itemCount: 6, baseMinutes: 45, weight: 0.25 },
      { skill: 'LISTENING', part: 'Comprensión auditiva', format: 'listening', itemCount: 5, baseMinutes: 30, weight: 0.25 },
      { skill: 'WRITING', part: 'Expresión e interacción escritas', format: 'writing', itemCount: 2, baseMinutes: 50, weight: 0.25 },
      { skill: 'SPEAKING', part: 'Expresión e interacción orales', format: 'speaking', itemCount: 3, baseMinutes: 15, weight: 0.25 },
    ],
  },
  ...
  CAMBRIDGE: {
    ...
    sections: [
      { skill: 'READING', part: 'Reading', format: 'mc', itemCount: 6, baseMinutes: 40, weight: 0.2 },
      { skill: 'GRAMMAR', part: 'Use of English', format: 'mc', itemCount: 6, baseMinutes: 30, weight: 0.2 },
      { skill: 'LISTENING', part: 'Listening', format: 'listening', itemCount: 5, baseMinutes: 30, weight: 0.2 },
      { skill: 'WRITING', part: 'Writing', format: 'writing', itemCount: 2, baseMinutes: 45, weight: 0.2 },
      { skill: 'SPEAKING', part: 'Speaking', format: 'speaking', itemCount: 3, baseMinutes: 15, weight: 0.2 },
    ],
  },
  ...
  CEFR_GENERIC: {
    ...
    sections: [
      { skill: 'READING', part: 'Reading', format: 'mc', itemCount: 6, baseMinutes: 40, weight: 0.25 },
      { skill: 'LISTENING', part: 'Listening', format: 'listening', itemCount: 5, baseMinutes: 30, weight: 0.25 },
      { skill: 'WRITING', part: 'Writing', format: 'writing', itemCount: 2, baseMinutes: 45, weight: 0.25 },
      { skill: 'SPEAKING', part: 'Speaking', format: 'speaking', itemCount: 3, baseMinutes: 15, weight: 0.25 },
    ],
  },
};
