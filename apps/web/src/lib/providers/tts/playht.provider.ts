/**
 * PlayHT TTS provider for Play3.0-mini multilingual synthesis.
 *
 ...
 *
 * The caller supplies an API key and user ID captured from the same account.
 *
...
export class PlayHtProvider implements TtsProvider {
  static readonly speechEndpoint = 'https://api.play.ht/api/v2/tts/stream';
