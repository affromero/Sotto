        ...
        <div className={styles.container}>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.sectionText}>
              ...
              impossible to remix. Writing a blog post takes hours. Recording a
              podcast takes weeks of planning. And once it&apos;s published, it&apos;s
              frozen — no one can build on it.
            </p>
            <p className={styles.sectionText}>
              Sotto changes this. We believe anyone should be able to turn an
              idea into a rich, listenable conversation in minutes — and that
              the best knowledge comes from building on what others have
              created. Forking, remixing, and extending ideas is how open
              source works. We&apos;re bringing that ethos to podcasting.
            </p>
            <p className={styles.sectionText}>
          ...
          <section className={styles.cta}>
            ...
            <p className={styles.ctaText}>
              We don&apos;t have a formal job board. If building an open podcast
              network excites you — whether you&apos;re an engineer, designer,
