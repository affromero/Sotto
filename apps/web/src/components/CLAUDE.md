...
| `landing/chapters/` | HeroChapter, JourneyChapter, TrustChapter, NetworkChapter, ConvertChapter                                                                                                                                                                                                                  | Landing page scrollytelling chapters: hero (video demo + CTA), journey (3-step sticky), trust (verification), network (social + providers), convert (pricing + CTA + footer) |
