...
| `settings/`      | VoicePreferenceSelector, TtsProviderCards, AiProviderCards, AvatarImageManager                                                                                                                                                                                                                | Voice preferences + TTS/AI provider BYOK key management + avatar image gallery               |
