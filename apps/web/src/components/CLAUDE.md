...
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| `ui/`            | Button, Input, Card, Modal, Toast, Badge (+ creator/admin/system variants), Chip, Spinner, CitationMarker, TtsProviderLogo, OverflowMenu                                                                                                                                                     | Shared primitives                                                                           |
...
| `create/`        | GenerationProgress, ScriptEditor, TtsProviderSelector, DurationSelector                                                                                                                                                                                                                      | Generation status + script review/edit + TTS provider selection + duration selection         |
| `import/`        | ImportUploader, ImportProgress                                                                                                                                                                                                                                                                | Audio import: drag-and-drop upload + pipeline status                                        |
| `feed/`          | PodcastCard, FeedGrid, TagFilter, SearchBar, TrendingSection, ActivityFeed, ActivityItem                                                                                                                                                                                                      | Public feed + activity feed + content-type badges (AI/Human/Imported)                       |
