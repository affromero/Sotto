...
| `discovery/`     | DiscoveryChat, SuggestionChips, RecommendationCard, CreatorSuggestion, InterestGrid, InspireMe, InspireQuiz, InspireTrendingList, VoicePicker, VoiceCard, HumeVoiceBrowser                                                                                                                     | Create flow + interest selection + topic inspiration + voice selection                      |
